...
//---- Start Generated from src/eau.html file --- 2020-12-25 18:04:08.524742
...
char* getTOE() { snprintf(strtmp, sizeof(strtmp), "%llu", flux.magnetHallPluse); return strtmp;}
...
char* getTst() {snprintf(strtmp, sizeof(strtmp), "(%llu, %llu)", flux.magnetHallPluse, flux.paddleWheelPulse); return strtmp;}
